...
def generate_launch_description():
    default_config_locks = os.path.join(get_package_share_directory('can_mux'),
                                        'config', 'can_mux_locks.yaml')
    default_config_topics = os.path.join(get_package_share_directory('can_mux'),
                                         'config', 'can_mux_topics.yaml')
    default_config_joystick = os.path.join(get_package_share_directory('can_mux'),
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'cmd_vel_out',
            default_value='/aiformula_control/can_mux/reference_signal',
        ...
        #     output='screen',
        #     remappings={('/Can', LaunchConfiguration('cmd_vel_out'))},
        #     parameters=[{
        #         'use_sim_time': LaunchConfiguration('use_sim_time'),
        #         'frame_id': 'base_link',
        #         'scale': 1.0,
